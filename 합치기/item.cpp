...
HRESULT item::init()
{
	...
	item1.img = IMAGEMANAGER->addImage("돈", "image/이지영/돈.bmp", 21, 21, true, RGB(255, 0, 255));
	item1.name = "무니";
	...
	item2.img = IMAGEMANAGER->addImage("초롱꽃", "image/이지영/초롱꽃.bmp", 72, 72, true, RGB(255, 0, 255));
	item2.name = "초롱꽃";
	...
	item3.img = IMAGEMANAGER->addImage("등가의훈장", "image/이지영/등가의훈장.bmp", 72, 72, true, RGB(255,0,255));
	item3.name = "등가의 훈장";
	...
	item4.img = IMAGEMANAGER->addImage("아스트랄부적", "image/이지영/아스트랄부적.bmp", 72, 72, true, RGB(255, 0, 255));
	item4.name = "아스트랄 부적";
