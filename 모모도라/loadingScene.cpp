...
void loadingScene::loadingImage()
{
	...
	_loading->loadImage("맵1-1", "image/background/map 1-1.bmp", 900, 846, true, RGB(255, 0, 255));
	_loading->loadImage("맵1-1픽셀", "image/background/map1-1_pixel.bmp", 900, 846, true, RGB(255, 0, 255));
