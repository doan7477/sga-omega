...
HRESULT sakura::init()
{
	...
	KEYANIMANAGER->addArrayFrameAnimation("ÁÂÀÌµ¿", "»çÄí¶ó", leftMove, 6, 10, true);
	int rightMove[] = { 6,7,8,9,10,11 };
	KEYANIMANAGER->addArrayFrameAnimation("¿ìÀÌµ¿", "»çÄí¶ó", rightMove, 6, 10, true);
	...
	KEYANIMANAGER->addArrayFrameAnimation("ÁÂ¾à¼Õ", "»çÄí¶ó", leftSoftPunch, 3, 10, true);
	int rightSoftPunch[] = { 31,32,33 };
	KEYANIMANAGER->addArrayFrameAnimation("¿ì¾à¼Õ", "»çÄí¶ó", rightSoftPunch, 3, 10, true);
	...
	KEYANIMANAGER->addArrayFrameAnimation("ÁÂ°­¼Õ", "»çÄí¶ó", leftStrongPunch, 7, 10, true);
	int rightStrongPunch[] = { 79,80,81,82,83,84,85 };
	KEYANIMANAGER->addArrayFrameAnimation("¿ì°­¼Õ", "»çÄí¶ó", rightStrongPunch, 7, 10, true);

	//¹ßÂ÷±â
	int leftKick[] = { 90,91,92,93,94 };
	KEYANIMANAGER->addArrayFrameAnimation("ÁÂ¹ß", "»çÄí¶ó", leftKick, 5, 10, true);
	int rightKick[] = { 95,96,97,98,99 };
	KEYANIMANAGER->addArrayFrameAnimation("¿ì¹ß", "»çÄí¶ó", rightKick, 5, 10, true);
